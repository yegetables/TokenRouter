...
marketplace: {
    ...
    pricingCurrentTier: 'Currently: {tier} ×{multiplier}',
    pricingTimeTier: '{tier} ×{multiplier}: {ranges}',
    pricingOtherTimes: 'Other times',
    pricingGroupPeak: 'Group peak ×{multiplier}: {start}–{end}',
    pricingInUse: 'active',
